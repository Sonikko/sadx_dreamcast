...
NJS_MATERIAL matlist_01DFDD9C[] = {
	{ { 0x6FFFFFFF },{ 0xFFFFFFFF }, 11, 34, NJD_D_100 | NJD_FILTER_BILINEAR | NJD_FLAG_CLAMP_U | NJD_FLAG_FLIP_V | NJD_FLAG_IGNORE_SPECULAR | NJD_FLAG_USE_ALPHA | NJD_FLAG_USE_TEXTURE | NJD_FLAG_IGNORE_LIGHT | NJD_DA_ONE | NJD_SA_INV_SRC }
};
...
NJS_OBJECT spotlight1 = { NJD_EVAL_UNIT_POS | NJD_EVAL_UNIT_ANG | NJD_EVAL_UNIT_SCL | NJD_EVAL_BREAK, &attach_01DFDE48, 291.83f, 0.1f, 385.525f, 0x4000, 0, 0, 1, 1, 1, NULL, NULL };

NJS_OBJECT spotlight2 = { NJD_EVAL_UNIT_POS | NJD_EVAL_UNIT_ANG | NJD_EVAL_UNIT_SCL | NJD_EVAL_BREAK, &attach_01DFDE48, 313, 0.11f, 389.525f, 0x4000, 0, 0, 1, 1, 1, NULL, NULL };

NJS_OBJECT spotlight3 = { NJD_EVAL_UNIT_POS | NJD_EVAL_UNIT_ANG | NJD_EVAL_UNIT_SCL | NJD_EVAL_BREAK, &attach_01DFDE48, 368.06f, 0.1f, 340.66f, 0x4000, 0, 0, 1, 1, 1, NULL, NULL };

NJS_OBJECT spotlight4 = { NJD_EVAL_UNIT_POS | NJD_EVAL_UNIT_ANG | NJD_EVAL_UNIT_SCL | NJD_EVAL_BREAK, &attach_01DFDE48, 385.06f, 0.11f, 330.66f, 0x4000, 0, 0, 1, 1, 1, NULL, NULL };

NJS_OBJECT spotlight5 = { NJD_EVAL_UNIT_POS | NJD_EVAL_UNIT_ANG | NJD_EVAL_UNIT_SCL | NJD_EVAL_BREAK, &attach_01DFDE48, 160.685f, 0.1f, 348.04f, 0x4000, 0, 0, 1, 1, 1, NULL, NULL };

NJS_OBJECT spotlight6 = { NJD_EVAL_UNIT_POS | NJD_EVAL_UNIT_ANG | NJD_EVAL_UNIT_SCL | NJD_EVAL_BREAK, &attach_01DFDE48, 183.685f, 0.11f, 360.04f, 0x4000, 0, 0, 1, 1, 1, NULL, NULL };

NJS_OBJECT spotlight7 = { NJD_EVAL_UNIT_POS | NJD_EVAL_UNIT_ANG | NJD_EVAL_UNIT_SCL | NJD_EVAL_BREAK, &attach_01DFDE48, 258.325f, 0.1f, 434.675f, 0x4000, 0, 0, 1, 1, 1, NULL, NULL };

NJS_OBJECT spotlight8 = { NJD_EVAL_UNIT_POS | NJD_EVAL_UNIT_ANG | NJD_EVAL_UNIT_SCL | NJD_EVAL_BREAK, &attach_01DFDE48, 235.325f, 0.1f, 440.675f, 0x4000, 0, 0, 1, 1, 1, NULL, NULL };
