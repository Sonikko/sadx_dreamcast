...
NJS_MATERIAL matlist_001489B8[] = {
	{ { 0x3B7F7FFF },{ 0xFFFFFFFF }, 11, OBJ_HIGHWAYTexName_st3_mado, NJD_D_100 | NJD_FILTER_BILINEAR |	NJD_FLAG_CLAMP_V | NJD_FLAG_CLAMP_U | NJD_FLAG_IGNORE_SPECULAR | NJD_FLAG_USE_ALPHA | NJD_FLAG_USE_TEXTURE | NJD_FLAG_USE_ENV | NJD_DA_INV_SRC | NJD_SA_SRC }
};
