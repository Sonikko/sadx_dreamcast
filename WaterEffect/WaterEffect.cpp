...
void __cdecl Obj_EC23Water_DisplayX(ObjectMaster *a1)
{
	...
	if (!DroppedFrames)
	{
		...
		ProcessModelNode_A_Wrapper((NJS_OBJECT*)0x10C05E8, 8, 1.0f);
		njPopMatrix(1u);
		...
		{
		AllocateQueuedModelCallback((void(__cdecl *)(void *))DrawEmeraldCoastOcean, &OceanDataB, -17952.0, 0);
	}
}
...
void __cdecl Obj_EC1Water_DisplayX(ObjectMaster *a1)
{
	...
	if (!DroppedFrames)
	{
		...
		ProcessModelNode_A_Wrapper((NJS_OBJECT*)0x010C03FC, 8, 1.0f);
		njPopMatrix(1u);

		njPushMatrix(0);
		njTranslate(0, v1->Position.x - 2000, EC1OceanYShift, v1->Position.z);
		ProcessModelNode_A_Wrapper(&object_00CC03FC, 8, 1.0f);
		njPopMatrix(1u);
...
extern "C" __declspec(dllexport) void __cdecl Init()
{
	...
	WriteData((void*)0x004F76DE, 0x90, 5); //Kill first water in Act 2
	WriteData((void*)0x004F777E, 0x90, 5); //Kill first water in Act 3
