...
NJS_OBJECT spotlight1 = { NJD_EVAL_UNIT_POS | NJD_EVAL_UNIT_ANG | NJD_EVAL_UNIT_SCL | NJD_EVAL_BREAK, &attach_01DFDE48, 291.83f, 0.1f, 387.525f, 0x4000, 0, 0, 1, 1, 1, NULL, NULL };
