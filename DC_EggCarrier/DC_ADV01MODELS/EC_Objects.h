...
NJS_MATERIAL matlist_00111440[] = {
	{ { 0xFFB2B2B2 },{ 0xFFFFFFFF }, 11, EC_TARAITexName_edv_f_mojia, NJD_D_100 | NJD_FILTER_BILINEAR | NJD_FLAG_CLAMP_V | NJD_FLAG_CLAMP_U | NJD_FLAG_USE_ALPHA | NJD_FLAG_USE_TEXTURE | NJD_DA_INV_SRC | NJD_SA_SRC }
};
...
NJS_MATERIAL matlist_0011154C[] = {
	...
	{ { 0xFFB2B2B2 },{ 0xFFFFFFFF }, 11, EC_TARAITexName_edv_k_traingarasu, NJD_D_100 | NJD_FILTER_BILINEAR | NJD_FLAG_CLAMP_V | NJD_FLAG_CLAMP_U | NJD_FLAG_USE_TEXTURE | NJD_FLAG_USE_ENV | NJD_DA_INV_SRC | NJD_SA_SRC },
...
NJS_MESHSET_SADX meshlist_001116A0[] = {
	{ NJD_MESHSET_TRIMESH | 0, 1, poly_001115D0, NULL, NULL, NULL, uv_00111668, NULL },
...
NJS_MODEL_SADX attach_00111938Z = { vertex_001116F8, normal_00111818, LengthOfArray(vertex_001116F8), meshlist_001116A0, matlist_0011154CZ, LengthOfArray(meshlist_001116A0Z), LengthOfArray(matlist_0011154CZ),{ 0, 0, -0.00002f }, 14.81621f, NULL };

NJS_OBJECT object_00111964Z = { NJD_EVAL_UNIT_POS | NJD_EVAL_UNIT_ANG | NJD_EVAL_UNIT_SCL, &attach_00111938Z, 0, 0, 0, 0, 0, 0, 1, 1, 1, NULL, NULL };
