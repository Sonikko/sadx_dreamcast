...
NJS_MATERIAL matlist_0007C334[] = {
	{ { 0x80B2B2B2 },{ 0xFFFFFFFF }, 10, KAOS_EMETexName_objef_emefgren, NJD_D_100 | NJD_FILTER_BILINEAR | NJD_FLAG_CLAMP_V | NJD_FLAG_CLAMP_U | NJD_FLAG_IGNORE_SPECULAR | NJD_FLAG_USE_ALPHA | NJD_FLAG_USE_TEXTURE | NJD_FLAG_IGNORE_LIGHT | NJD_DA_ONE | NJD_SA_SRC }
};
...
NJS_OBJECT object_8D48F39A4A35FE206B1 = { NJD_EVAL_UNIT_POS | NJD_EVAL_UNIT_ANG | NJD_EVAL_UNIT_SCL | NJD_EVAL_BREAK | NJD_EVAL_SKIP | NJD_EVAL_SHAPE_SKIP, &attach_0007C3B8, 0, 0, 0, 0, 0, 0, 1, 1, 1, NULL, NULL };