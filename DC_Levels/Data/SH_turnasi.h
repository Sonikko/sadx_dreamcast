...
NJS_MATERIAL matlistSTG04_00149DCC[] = {
...
Sint16 polySTG04_00149E1C[] = {
	12, 26, 27, 40, 41, 25, 24, 36, 37, 42, 43, 34, 39,
	6, 25, 36, 40, 42, 26, 34,
	6, 37, 24, 43, 41, 39, 27
};

Sint16 polySTG04_00149E52[] = {
	4, 31, 30, 38, 35,
...
Sint16 polySTG04_00149EE8[] = {
	4, 45, 47, 44, 46,
	10, 29, 46, 28, 47, 31, 45, 30, 44, 29, 46
};

NJS_TEX uvSTG04_00149F08[] = {
	{ 0 },
	{ 254, 0 },
	{ 0, 15 },
	{ 254, 15 },
...
NJS_MESHSET_SADX meshlistSTG04_0014A0A8[] = {
	{ NJD_MESHSET_TRIMESH | 0, 3, polySTG04_00149E1C, NULL, NULL, NULL, uvSTG04_00149F08, NULL },
	{ NJD_MESHSET_TRIMESH | 1, 4, polySTG04_00149E52, NULL, NULL, NULL, uvSTG04_00149F68, NULL },
	{ NJD_MESHSET_TRIMESH | 2, 5, polySTG04_00149E8A, NULL, NULL, NULL, uvSTG04_00149FC8, NULL },
	{ NJD_MESHSET_TRIMESH | 3, 2, polySTG04_00149EE8, NULL, NULL, NULL, uvSTG04_0014A070, NULL }
};

NJS_VECTOR normalSTG04_0014A108[] = {
...
NJS_VECTOR normalSTG04_0014A348[] = {
...
NJS_MODEL_SADX attachSTG04_0014A588 = { normalSTG04_0014A108, normalSTG04_0014A348, LengthOfArray(normalSTG04_0014A108), meshlistSTG04_0014A0A8, matlistSTG04_00149DCC, LengthOfArray(meshlistSTG04_0014A0A8), LengthOfArray(matlistSTG04_00149DCC),{ 0, 0.000002f, 0 }, 46.86534f, NULL };

NJS_OBJECT objectSTG04_0014A5B0 = { NJD_EVAL_UNIT_ANG | NJD_EVAL_UNIT_SCL | NJD_EVAL_BREAK, &attachSTG04_0014A588, 0.000003f, -24, 0.000004f, 0, 0, 0, 1, 1, 1, NULL, NULL };

NJS_MATERIAL matlistSTG04_0014A5E4[] = {
...
NJS_MESHSET_SADX meshlistSTG04_0014A810[] = {
	{ NJD_MESHSET_TRIMESH | 1, 4, polySTG04_0014A620, NULL, NULL, NULL, uvSTG04_0014A6D0, NULL },
	{ NJD_MESHSET_TRIMESH | 2, 4, polySTG04_0014A690, NULL, NULL, NULL, uvSTG04_0014A7A0, NULL }
};

NJS_VECTOR normalSTG04_0014A840[] = {
	{ 9, -2.7104f, 0 },
	{ -9, -2.7104f, 0 },
...
NJS_VECTOR normalSTG04_0014A9F0[] = {
	{ 0.609994f, -0.792406f, 0 },
	{ -0.609994f, -0.792406f, 0 },
	{ 0.609994f, -0.396203f, 0.686244f },
	{ -0.609994f, -0.396203f, 0.686244f },
...
NJS_MODEL_SADX attachSTG04_0014ABA0 = { normalSTG04_0014A840, normalSTG04_0014A9F0, LengthOfArray(normalSTG04_0014A840), meshlistSTG04_0014A810, matlistSTG04_0014A5E4, LengthOfArray(meshlistSTG04_0014A810), LengthOfArray(matlistSTG04_0014A5E4),{ 0, -12.6448f, 0.000004f }, 42.89304f, NULL };

NJS_OBJECT objectSTG04_0014ABC8 = { NJD_EVAL_UNIT_ANG | NJD_EVAL_UNIT_SCL, &attachSTG04_0014ABA0, 0, -51, 0.000004f, 0, 0, 0, 1, 1, 1, &objectSTG04_0014A5B0, NULL };

NJS_MATERIAL matlistSTG04_0014ABFC[] = {
...
NJS_MESHSET_SADX meshlistSTG04_0014AE1C[] = {
	{ NJD_MESHSET_TRIMESH | 0, 4, polySTG04_0014AC38, NULL, NULL, NULL, uvSTG04_0014ACEC, NULL },
	{ NJD_MESHSET_TRIMESH | 1, 4, polySTG04_0014AC78, NULL, NULL, NULL, uvSTG04_0014AD5C, NULL },
	{ NJD_MESHSET_TRIMESH | 2, 6, polySTG04_0014ACA0, NULL, NULL, NULL, uvSTG04_0014AD9C, NULL }
};

NJS_VECTOR normalSTG04_0014AE64[] = {
	{ 6, -2.800008f, 0 },
	{ -6, -2.800008f, 0 },
...
NJS_VECTOR normalSTG04_0014AFB4[] = {
	{ 0.609994f, -0.792406f, 0 },
	{ -0.609994f, -0.792406f, 0 },
	{ 0.609994f, -0.396203f, 0.686244f },
	{ -0.609994f, -0.396203f, 0.686244f },
...
NJS_MODEL_SADX attachSTG04_0014B104 = { normalSTG04_0014AE64, normalSTG04_0014AFB4, LengthOfArray(normalSTG04_0014AE64), meshlistSTG04_0014AE1C, matlistSTG04_0014ABFC, LengthOfArray(meshlistSTG04_0014AE1C), LengthOfArray(matlistSTG04_0014ABFC),{ 0, -25, 0.000002f }, 29.61418f, NULL };

NJS_OBJECT objectSTG04_0227DC14 = { NJD_EVAL_UNIT_POS | NJD_EVAL_UNIT_ANG | NJD_EVAL_UNIT_SCL, &attachSTG04_0014B104, 0, 0, 0, 0, 0, 0, 1, 1, 1, &objectSTG04_0014ABC8, NULL };
